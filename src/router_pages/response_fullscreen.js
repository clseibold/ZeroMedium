					...
					<div class="column is-three-quarters-tablet is-half-desktop">
						<div v-if="response">
							...
							<div style="margin-left: 20px; margin-bottom: 20px;" v-if="response.story">
								Responded to <a :href="'./?/' + getStoryAuthAddress + '/' + response.story.slug" v-on:click.prevent="goto(getStoryAuthAddress  + '/' + response.story.slug)">{{ response.story.title ? response.story.title : "[NO TITLE]" }}</a><br>
