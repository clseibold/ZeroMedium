...
var Newstory = {
	...
	template: `
		<div>
			<editor-nav v-on:publish="publish" v-on:save="save"></editor-nav>
...
Vue.component('editor-nav', {
	...
	data: function() {
		return {
			status: 'Unsaved changes', // Unsaved changes, Saved, ''
			tags: '',
			description: ''
		}
	},
		...
		<div class="navbar is-transparent has-shadow" style="border-top: 1px solid rgba(0,0,0,.05);">
            <div class="container">
            	<div class="navbar-brand">
                	<div class="navbar-item">Draft</div>
                	<div class="navbar-item" style="padding-left: 5px; padding-right: 5px; color: #9A9A9A;"><small>{{status}}<small></div>
