	...
	template: `
		<div class="box" style="margin-bottom: 20px;">
			...
			<div style="margin-left: 20px; margin-bottom: 20px;" v-if="showReference && story">
				Responded to <a :href="'./?/' + getStoryAuthAddress(story) + '/' + story.slug" v-on:click.prevent="goto(getStoryAuthAddress(story)  + '/' + story.slug)">{{ story.title !== "" ? story.title : "[NO TITLE]" }}</a><br>
